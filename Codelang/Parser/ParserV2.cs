...
namespace Codelang
{
        ...
        private ExpressionSyntax ParsePrimaryExpression()
        {
            ...
            if (Current.TokenType == TokenTypes.KEYWORD)
            {
                if (Current.Value == "var")
                {
                    ...
                    return new DefineVariableSyntax(varDecl, name, colon, typeToken, equalType, value);
                }
    ...
    {
        public DefineVariableSyntax (Token variableToken, Token nameToken, Token typeColon, Token typeName, Token equalType, ExpressionSyntax valueExpression)
        {
